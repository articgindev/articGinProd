  ...
  return (
    <video loop muted id="autoplay" playsInline className="background-video">
      <source
        src={
          isMobile
            ? 'https://res.cloudinary.com/dtu2unujm/video/upload/f_auto:video,q_auto/fondoCel_br0wnh.mp4'
            : 'https://res.cloudinary.com/dtu2unujm/video/upload/f_auto:video,q_auto/fondoPc_yyrpxb.mp4'
        }
        type="video/mp4"
      />
